...
- 스냅샷 인덱스 문서 추가: [docs/snapshots/README.md](../snapshots/README.md)
- 스냅샷 8종 정리:
...
- 관련 문서:
  - [docs/dev-sidebar-migration.md](../dev-sidebar-migration.md)
  - [docs/snapshots/README.md](../snapshots/README.md)
